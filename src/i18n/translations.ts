...
export const translations: Record<AppLanguage, TranslationTree> = {
  de: {
    ...
    subscription: {
      ...
      pauseModalMessage: "Weitere Buchungen werden ausgesetzt und als Sparen gespeichert.",
      pauseModalConfirm: "OK",
      resumeModalTitle: "Das Abo wird fortgeführt",
      resumeModalMessage: "Kommende Buchungen werden wieder normal als Zahlungen verbucht.",
      resumeModalConfirm: "OK",
      confirmCancelTitle: "Abo kündigen",
      confirmCancelMessage: "Möchtest du dieses Abo wirklich kündigen? Es werden keine weiteren Zahlungen gebucht. Deine akteulle Statistik bleibt erhalten. Neues kommt aber nicht dazu.",
      confirmCancelAction: "Kündigen",
      confirmDeleteTitle: "Abo löschen",
      confirmDeleteMessage: "Möchtest du dieses Abo wirklich löschen? Das Abo wird aus deiner Übersicht entfernt und die Daten werden aus deiner Statistik entfernt. Eine Reaktivierung des Abos ist dann nicht mehr möglich.",
      confirmDeleteAction: "Löschen",
      skippedPaymentsSaved: "{{count}} ausgesetzte Zahlungen · {{amount}} gespart",
      resumeTitle: "Abo fortführen",
      pauseTitle: "pausieren (reaktivierbar)",
