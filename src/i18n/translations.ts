...
export const translations: Record<AppLanguage, TranslationTree> = {
  de: {
    ...
    settings: {
      ...
      purchaseDescription: "Unterstütze die App und schalte weitere Akzentfarben frei",
      ...
      purchaseLockedHint:
        "Nur die Standardfarbe ist kostenlos. Alle weiteren Farben werden mit diesem einmaligen Kauf freigeschaltet.",
    },
    auth: {
      email: "E-Mail",
      password: "Passwort",
  ...
  en: {
    ...
    settings: {
      ...
      purchaseDescription: "Support the app and unlock more accent colors",
      ...
      purchaseLockedHint:
        "Only the default accent color is free. All other colors unlock with this one-time purchase.",
    },
    auth: {
      email: "Email",
      password: "Password",
