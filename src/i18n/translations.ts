...
export const translations: Record<AppLanguage, TranslationTree> = {
  de: {
    ...
    stats: {
      ...
      costsColumn: "Kosten",
      savingsColumn: "Sparen",
      currentMonthProjected: "Aktueller Monat voraussichtlich",
      currentMonthProjectedSavings: "Aktueller Monat voraussichtlich",
      averageMonthlyActual: "Durchschnittliche Monatskosten",
      averageMonthlySavings: "Durchschnittliche Monatsersparnis",
      highestActualMonth: "Teuerster Monat",
      highestActualMonthEmpty: "Noch keine IST-Zahlungen",
      highestSavedMonth: "Meiste Ersparnis",
      highestSavedMonthEmpty: "Noch keine IST-Ersparnisse",
      billingStructure: "Seltene Zahlungen im Blick behalten",
      ...
      savingsAllTime: "Gesamte Sparsumme",
      noSavingsAvailable: "Keine pausierten Abos vorhanden",
      savingsFooter: "Schau mit welchen Abos du sparst",
      yearActualCurrent: "Gesamtkosten {{year}} IST",
      yearActualPrevious: "Gesamtkosten {{year}} IST",
  ...
  en: {
    ...
    stats: {
      ...
      savingsAllTime: "Total (all-time savings)",
