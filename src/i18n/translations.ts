...
export const translations: Record<AppLanguage, TranslationTree> = {
  de: {
    ...
    stats: {
      ...
      billingRareClaim: "Seltene Zahlungen im Blick",
      ...
      categoriesOverviewClaim: "Ausgaben nach Kategorien",
  ...
  en: {
    ...
    stats: {
      ...
      billingRareClaim: "Keep infrequent payments in view",
      ...
      categoriesOverviewClaim: "Spending by category",
