...
export const translations: Record<AppLanguage, TranslationTree> = {
  de: {
    common: {
      ...
      syncRetryPending: "Erneuter Versuch",
      syncLocalOnly: "Nur lokal",
      syncStatusReady: "Alles synchronisiert",
      syncPendingDescription: "Deine letzte Änderung wird mit der Cloud abgeglichen.",
      syncRetryPendingDescription: "Die letzte Änderung wird beim nächsten Versuch erneut synchronisiert.",
      syncLocalOnlyDescription: "Dieser Eintrag ist lokal bereits sichtbar und wird synchronisiert, sobald die Cloud erreichbar ist.",
    },
    tabs: {
      home: "Home",
      calendar: "Kalender",
    ...
    onboarding: {
      ...
      howItWorksTrackDescription: "Behalte im Auge, wie viel du zahlst.",
    ...
    settings: {
      ...
      notificationsEnabled: "An",
      notificationsDisabled: "Aus",
      notificationTestTitle: "Benachrichtigung testen",
      notificationTestDescription: "Plant die heutige Tages-Benachrichtigung einmalig in wenigen Sekunden.",
      notificationTestButton: "Tages-Benachrichtigung testen",
      notificationTestNoDueTitle: "Heute nichts fällig",
      notificationTestNoDueDescription: "Für heute sind keine aktiven fälligen Abos vorhanden.",
      notificationTestScheduledTitle: "Test geplant",
      notificationTestScheduledDescription: "Die Tages-Benachrichtigung wurde für in wenigen Sekunden geplant.",
      notificationTestPermissionDenied: "Benachrichtigungen sind auf diesem Gerät aktuell nicht erlaubt.",
      notificationTestFailed: "Die Test-Benachrichtigung konnte gerade nicht geplant werden.",
      accentIndigo: "Indigo",
      accentSlate: "Slate",
      accentBlue: "Blau",
      accentSage: "Sage",
      ...
      premiumUpgrade: "OctoVault Premium freischalten",
      ...
      purchaseDescription: "Schalte OctoVault Premium frei und erhalte unbegrenzte Abos sowie zusätzliche Akzentfarben.",
      purchaseBuy: "OctoVault Premium für {{price}}",
      ...
      contactScreenIntro:
        "Sende uns dein Anliegen direkt aus der App. Wir schicken dir nach dem Absenden automatisch eine kurze Eingangsbestätigung per E-Mail.",
      contactCategoryLabel: "Kategorie",
      contactCategorySuggestion: "Verbesserungsvorschlag",
      contactCategoryBug: "Bug",
      contactCategoryQuestion: "Anfrage",
      ...
      contactMessagePlaceholder: "Beschreibe dein Anliegen möglichst klar und kurz.",
      contactEmailLabel: "Absender-E-Mail",
      ...
      contactValidationSubject: "Bitte gib einen Betreff ein.",
      contactValidationSubjectLength: "Der Betreff darf maximal {{max}} Zeichen lang sein.",
      contactValidationMessage: "Bitte gib eine Nachricht ein.",
      contactValidationMessageLength: "Die Nachricht darf maximal {{max}} Zeichen lang sein.",
      contactValidationEmail: "Bitte gib eine E-Mail-Adresse ein.",
      contactValidationEmailFormat: "Bitte gib eine gültige E-Mail-Adresse ein.",
    ...
    allSubscriptions: {
      ...
      pendingSyncSummary: "{{count}} Änderung wartet auf Abgleich",
      pendingSyncSummary_plural: "{{count}} Änderungen warten auf Abgleich",
      ...
      amount: "Betrag",
      billingCycle: "Intervall",
      nextPayment: "Nächste Zahlung",
      detailsLink: "Detailsansicht >",
    },
    stats: {
      title: "Statistiken",
      summaryClaim: "Diesen Monat insgesamt {{amount}}",
      savingsClaim: "Bisher gespart: {{amount}}",
      categoriesClaim: "Stärkste Kategorie: {{label}}",
      developmentClaim: "Aktuelle Monatsprognose: {{amount}}",
      developmentAverageClaim: "Deine durchschnittlichen Monatskosten betragen {{amount}}",
      billingClaim: "{{count}} aktive Abos nach Intervall",
      billingRareClaim: "Seltene Zahlungen nicht aus den Augen verlieren",
      billingYearlySummary: "Du zahlst {{count}} Abos 1 Mal im Jahr und zahlst dabei {{amount}}.",
      billingQuarterlySummary: "Du zahlst {{count}} Abos quartalsweise und zahlst dabei {{amount}}.",
      topSubscriptionsClaim: "Teuerstes Abo: {{name}}",
      entertainmentClaim: "{{amount}} um dich zu unterhalten",
      entertainmentTitle: "Unterhaltungskosten",
      entertainmentCount: "Du nutzt {{count}} Abos zur Unterhaltung",
      entertainmentExamples: "Zum Beispiel: {{examples}}",
      entertainmentSavingsHint: "Hier könntest du versuchen zu sparen",
      entertainmentAverageHint: "Im Durchschnitt geben Nutzer 24,90 € für Unterhaltung aus",
      entertainmentEmpty: "Aktuell sind keine Unterhaltung-Abos aktiv.",
      categoriesOverviewClaim: "Kategorien",
      categoriesOverviewTitle: "Kategorien",
      categoriesExpand: "Alle Kategorien anzeigen",
      categoriesCollapse: "Weniger anzeigen",
      topSubscriptionsExtraTitle: "Deine teuersten Abos",
      topSubscriptionsShare: "Diese machen {{percent}} deiner Kosten aus",
    ...
    subscription: {
      ...
      limitReachedMessage:
        "Du nutzt 10 von 10 Abos. Wechsle zu Premium für unbegrenzt viele Abos.",
      limitReachedUpgrade: "Mehr erfahren",
      ...
      historyShowAll: "Alle anzeigen & bearbeiten",
  ...
  en: {
    common: {
      ...
      syncPending: "Pending",
      syncing: "Syncing...",
      syncRetryPending: "Retry pending",
      syncLocalOnly: "Local only",
      syncStatusReady: "Everything synced",
      syncPendingDescription: "Your latest change is being synced to the cloud.",
      syncRetryPendingDescription: "The latest change will be retried during the next sync attempt.",
      syncLocalOnlyDescription: "This entry is already visible locally and will sync once the cloud is reachable.",
    },
    tabs: {
      home: "Home",
      calendar: "Calendar",
    ...
    onboarding: {
      ...
      howItWorksAddTitle: "All subscriptions in one place",
      howItWorksAddDescription: "See your subscriptions clearly in one place.",
      howItWorksTrackTitle: "Spending in view",
      howItWorksTrackDescription: "Keep an eye on how much you pay.",
    ...
    settings: {
      ...
      notificationTestDescription: "Schedules today's daily-due notification once a few seconds from now.",
      notificationTestButton: "Test daily notification",
      notificationTestNoDueTitle: "Nothing due today",
      notificationTestNoDueDescription: "There are no active due subscriptions for today.",
      notificationTestScheduledTitle: "Test scheduled",
      notificationTestScheduledDescription: "The daily-due notification was scheduled for a few seconds from now.",
      notificationTestPermissionDenied: "Notifications are currently not allowed on this device.",
      notificationTestFailed: "The test notification could not be scheduled right now.",
      accentIndigo: "Indigo",
      accentSlate: "Slate",
      accentBlue: "Blue",
      accentSage: "Sage",
      ...
      premiumCardTitleFree: "PREMIUM",
      premiumCardTitlePremium: "OctoVault Premium is active",
      premiumCardDescriptionFree: "Remove the limit of 10 subscriptions.\nUnlock it once with OctoVault Premium.",
      ...
      premiumUpgrade: "Unlock OctoVault Premium",
      ...
      purchaseDescription: "Unlock OctoVault Premium for unlimited subscriptions and additional accent colors.",
      purchaseBuy: "Get OctoVault Premium for {{price}}",
      ...
      contactScreenIntro:
        "Send us your request directly from the app. After sending, you will automatically receive a short confirmation email.",
      ...
      contactMessagePlaceholder: "Describe your request as clearly and briefly as possible.",
      contactEmailLabel: "Reply email",
      ...
      contactValidationSubject: "Please enter a subject.",
      contactValidationSubjectLength: "The subject may contain at most {{max}} characters.",
      contactValidationMessage: "Please enter a message.",
      contactValidationMessageLength: "The message may contain at most {{max}} characters.",
      contactValidationEmail: "Please enter an email address.",
      contactValidationEmailFormat: "Please enter a valid email address.",
      contactModalDescription:
    ...
    allSubscriptions: {
      ...
      pendingSyncSummary: "{{count}} change waiting to sync",
      pendingSyncSummary_plural: "{{count}} changes waiting to sync",
      ...
      detailsLink: "Details view >",
    },
    stats: {
      title: "Statistics",
      summaryClaim: "Total this month: {{amount}}",
      savingsClaim: "Saved so far: {{amount}}",
      categoriesClaim: "Top category: {{label}}",
      developmentClaim: "Current monthly projection: {{amount}}",
      developmentAverageClaim: "Your average monthly costs are {{amount}}",
      billingClaim: "{{count}} active subscriptions by interval",
      billingRareClaim: "Don't lose sight of infrequent payments",
      billingYearlySummary: "You pay for {{count}} subscriptions once a year and spend {{amount}} on them.",
      billingQuarterlySummary: "You pay for {{count}} subscriptions quarterly and spend {{amount}} on them.",
      topSubscriptionsClaim: "Most expensive subscription: {{name}}",
      entertainmentClaim: "{{amount}} to entertain yourself",
      entertainmentTitle: "Entertainment costs",
      entertainmentCount: "You use {{count}} subscriptions for entertainment",
      entertainmentExamples: "For example: {{examples}}",
      entertainmentSavingsHint: "This could be a good place to save",
      entertainmentAverageHint: "On average, users spend €24.90 on entertainment",
      entertainmentEmpty: "No entertainment subscriptions are active right now.",
      categoriesOverviewClaim: "Categories",
      categoriesOverviewTitle: "Categories",
      categoriesExpand: "Show all categories",
      categoriesCollapse: "Show less",
      topSubscriptionsExtraTitle: "Your most expensive subscriptions",
      topSubscriptionsShare: "These make up {{percent}} of your costs",
    ...
    subscription: {
      ...
      limitReachedMessage:
        "You are using 10 of 10 subscriptions. Upgrade to Premium for unlimited subscriptions.",
      limitReachedUpgrade: "Learn more",
      standardPlan: "Standard plan",
      businessRenewal: "Business renewal due next month",
