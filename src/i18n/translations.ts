...
export const translations: Record<AppLanguage, TranslationTree> = {
  de: {
    ...
    settings: {
      ...
      premiumModalDescription:
        "Mit Premium hebst du das Limit von 10 Abos auf. Deine bestehenden Kaufoptionen bleiben erhalten und lassen sich jederzeit wiederherstellen.",
      premiumFreeCardTitle: "FREE",
      premiumItemSubscriptionsFree: "Bis zu 10 Abos",
      premiumItemSubscriptionsPremium: "Unbegrenzte Abos",
      premiumItemHistoryFree: "Endlose Historie",
      premiumItemHistoryPremium: "Unbegrenzte Historie",
      premiumItemCloudFree: "Cloud-Sicherung der Daten",
  ...
  en: {
    ...
    settings: {
      ...
      premiumActiveTitle: "Premium (active: {{plan}})",
      premiumCardDescription: "Take a look at your benefits with Premium.",
      premiumPlanBadge: "Premium",
      freePlanBadge: "Free",
